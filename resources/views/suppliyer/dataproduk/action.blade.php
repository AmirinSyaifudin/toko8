<a href="{{ route('suppliyerproduk.edit', $model) }}" class="btn btn-warning">Edit</a>
<button href="{{ route('produk.destroy', $model) }}" onclick="md.showNotification('top','right')" class="btn btn-danger" id="delete">Hapus</button>
