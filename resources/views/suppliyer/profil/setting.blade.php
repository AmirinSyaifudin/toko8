            ...
            <div class="box-body">
                ...
                @csrf
                    ...
                    <div class="form-group @error('nama') has-error @enderror">
                        <label for="">NAMA SUPPLIYER</label>
                    ...
                    <div class="form-group @error('email') has-error @enderror">
                     ...
                     <div class="form-group @error('kontak_suplier') has-error @enderror">
                        ...
                        <input type="text" name="kontak_suplier" class="form-control" placeholder="Masukkan Kontak" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="submit" value="SAVE DATA PROFIL SUPPLIYER" class ="btn btn-primary">
                    </div>
                </form>
            </div>
    </div>
